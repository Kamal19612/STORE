...
import com.sucrestore.api.dto.OrdersSheetSyncSummary;
...
public class OrdersGoogleSheetsSyncService {
    ...
    /**
     * Synchronisation automatique (toutes les minutes par défaut).
     * Désactivable via app_settings.google_orders_sheet_sync_enabled = "false".
     */
    @org.springframework.scheduling.annotation.Scheduled(
        fixedDelayString = "${orders.sheets.sync-rate:60000}",
