...
self.addEventListener("push", (event) => {
  ...
  try {
    ...
    payload = { title: "Sucre Store", body: event.data.text() };
  }
  ...
  event.waitUntil(
    self.registration.showNotification(payload.title || "Sucre Store", options)
  );
});
