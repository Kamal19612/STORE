 ...
 * À remplacer par le vrai dashboard avec statistiques
 */
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-gray-600">
          Cette page sera bientôt remplie avec des statistiques et des
          graphiques.
        </p>
      </div>
        ...
        <div className="bg-gradient-to-br from-yellow-400 to-amber-500 rounded-lg shadow-lg p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold mt-2">-- FCFA</p>
            </div>
            <svg
