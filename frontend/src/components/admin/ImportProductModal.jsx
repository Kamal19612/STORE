          ...
          {!summary ? (
            <>
              ...
              <div className="flex gap-4 mb-6 border-b border-gray-100">
                <button
                  className={`pb-2 px-4 font-medium transition-colors border-b-2 ${activeTab === "file" ? "border-primary text-primary" : "border-transparent text-gray-400 hover:text-gray-600"}`}
                  onClick={() => setActiveTab("file")}
                >
                  Fichier CSV
                </button>
                <button
                  className={`pb-2 px-4 font-medium transition-colors border-b-2 ${activeTab === "url" ? "border-primary text-primary" : "border-transparent text-gray-400 hover:text-gray-600"}`}
              ...
              <div className="min-h-[150px]">
                {activeTab === "file" ? (
                  <label
                    ...
                    className={`border-2 border-dashed border-gray-200 rounded-xl p-8 flex flex-col items-center justify-center text-center transition-colors ${!file ? "hover:bg-gray-50 cursor-pointer" : ""}`}
                  >
            ...
            <div className="space-y-4">
              ...
              {summary.failureCount > 0 && (
                <div className="bg-red-50 p-4 rounded-xl border border-red-100">
                  ...
                  <div className="max-h-32 overflow-y-auto text-xs text-red-600 space-y-1 bg-white p-2 rounded border border-red-100">
